...
class_name StackTypeonCard

@export var source_selection_type = SelectionEventResource.SelectionType.RIFT
...
func on_execute() -> bool:
	...
	print(RiftGrid.Instance.grid[selected_pos.y][selected_pos.x])
